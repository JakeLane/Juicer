...
package me.jakelane.juicer.wifihotspotutils;
...
public class WifiApManager {
	...
	/**
	 * Start AccessPoint mode with the specified configuration. If the radio is already running in
	 * AP mode, update the new configuration Note that starting in access point mode disables
